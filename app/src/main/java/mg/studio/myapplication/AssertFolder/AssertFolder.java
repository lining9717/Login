package mg.studio.myapplication.AssertFolder;
...
public class AssertFolder extends AppCompatActivity {

    private static final String TAG_LOG = AssertFolder.class.getSimpleName();
    private static final int MY_PERMISSIONS_REQUEST_WRITE_LOCAL_STORAGE = 121;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.assertsfolder);
